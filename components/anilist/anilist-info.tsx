...
export default function AnilistInfo({ data }: { data: IAnimeResult }) {
  ...
  return (
    <>
      <div className="px-5 max-w-6xl md:mx-auto my-10 flex gap-10">
        <div className="w-full md:w-2/3 space-y-5">
          ...
          <div className="flex h-5 items-center space-x-4 text-sm ml-2">
            ...
            <div>Average Rating:4.9 (331.5k) </div>
            <Separator orientation="vertical" />
          ...
          <div className="flex ml-2 gap-5">
            ...
            <Button className="uppercase" variant="ghost" size="sm">
              <Plus className="mr-2 h-4 w-4" /> Add to Crunchylist
            </Button>
          </div>
