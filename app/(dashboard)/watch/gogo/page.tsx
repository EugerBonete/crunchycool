...
import { useGetGogoAnimeEpisode } from "@/context/episode-gogoanime";
...
export default function Watch() {
  ...
  const { data: info, isLoading: infoLoading } = useGetGogoAnimeInfo(
    anime as string
  );

  const { data, isLoading } = useGetGogoAnimeEpisode(episode as string);
